        ...
        <div class="col-md-12">
            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    <!-- /.box-header -->
                    <!-- form start -->
                    <?= $this->Form->create($session, array('role' => 'form')) ?>
                    <div class="box-body">
                        <?php
                                                            echo $this->Form->input('data', ['placeholder' => $session->data, 'disabled' => true]);
                                    echo $this->Form->input('expires', ['placeholder' => $session->expires, 'disabled' => true]);
                        ?>
                    </div>
                <!-- /.box-body -->
