        ...
        <div class="col-md-12">
            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    <!-- /.box-header -->
                    <!-- form start -->
                    <?= $this->Form->create($contentPath, array('role' => 'form')) ?>
                    <div class="box-body">
                        <?php
                                                            echo $this->Form->input('name', ['placeholder' => $contentPath->name, 'disabled' => true]);
                                    echo $this->Form->input('slug', ['placeholder' => $contentPath->slug, 'disabled' => true]);
                        ?>
                    </div>
                <!-- /.box-body -->
