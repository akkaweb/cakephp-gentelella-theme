 ...
 * @var \Cake\Datasource\EntityInterface $tagsTagged
 */
?>
...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                <br/>
                <?= $this->Form->create($tagsTagged, array('role' => 'form', 'class' => 'form-horizontal form-label-left', 'id' => 'form')) ?>

                <?php
                                            echo $this->Form->input('tag_id');
                                                        echo $this->Form->input('fk_id');
                                                        echo $this->Form->input('fk_table');
                                            ?>
