        ...
        <div class="col-md-12">
            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    <!-- /.box-header -->
                    <!-- form start -->
                    <?= $this->Form->create($seoTitle, array('role' => 'form')) ?>
                    <div class="box-body">
                        <?php
                                                            echo $this->Form->input('seo_uri_id', ['placeholder' => $seoTitle->seo_uri_id, 'disabled' => true]);
                                    echo $this->Form->input('title', ['placeholder' => $seoTitle->title, 'disabled' => true]);
                        ?>
                    </div>
                <!-- /.box-body -->
