...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                <br/>
                <?= $this->Form->create($translation, array('role' => 'form', 'class' => 'form-horizontal form-label-left', 'id' => 'form')) ?>

                <?php
                                            echo $this->Form->input('language_id');
                                                        echo $this->Form->input('object_foreign_key');
                                                        echo $this->Form->input('object_model');
                                                        echo $this->Form->input('object_field');
