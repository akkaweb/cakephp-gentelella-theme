        ...
        <div class="col-md-12">
            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <div class="box-body">
                        <?php
                                                            echo $this->Form->input('name', ['placeholder' => $region->name, 'disabled' => true]);
                                    echo $this->Form->input('slug', ['placeholder' => $region->slug, 'disabled' => true]);
                                    echo $this->Form->input('status', ['placeholder' => $region->status, 'disabled' => true]);
                        ?>
                    </div>
                <!-- /.box-body -->
