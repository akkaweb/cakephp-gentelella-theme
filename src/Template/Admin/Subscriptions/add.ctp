...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                <br/>
                <?= $this->Form->create($subscription, array('role' => 'form', 'class' => 'form-horizontal form-label-left', 'id' => 'form')) ?>

                <?php
                                            echo $this->Form->input('user_id');
                                                        echo $this->Form->input('subscription_plan_id');
                                                        echo $this->Form->input('transaction_idx');
                                                        echo $this->Form->input('merchant_profile_idx');
